Uses pywal (wal) to set colour scheme automatically in terminal, tty, and neovim. Check sway_wal.sh, sway/config, nvim/init.lua, and nvim/lua/custom/plugins.lua for info. 
